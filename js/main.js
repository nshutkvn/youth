...
if(posts)
  for (var i = 0; i < post_data.length; i++) {
    ...
    <div class="info">
      ...
      <div class="more">
          <img src="media/images/defaults/show_more.png" alt="show more">
      </div>
    </div>
    <div class="image">
      <img src="${post_data[i][3]}" >
      <img src="${post_data[i][4]}" >
    </div>
    <div class="desc">
      <div class="icons">
...
for (var i = 0; i < explore_date.length;i++) {
  ...
  <div class="item">
      ...
      <div class="bg"
        <div class="info">
          <div class="likes">
              <img src="media/images/defaults/heart_white.png" >
              <span>${explore_date[i][1]}</span>
          </div>
          <div class="comments">
              <img src="media/images/defaults/message.png" >
...
const reels_data = [
  ['video/video1.mp4',
  'media/images/defaults/profile_img.jpg',
  'zineb',
...
for(let i=0;i<reels_data.length;i++){
    ...
    <div class="content">
        <div class="sound">
            <img class="volume-up" src="media/images/defaults/volume-up.png" >
            <img class="volume-mute" src="media/images/defaults/volume-mute.png" >
        </div>
        <div class="play">
            <img src="media/images/defaults/play-button-arrowhead.png" >
        </div>
        <div class="info">
            <div class="profile">
                <h4><a href="#">
            ...
            <div class="desc">
                ...
                <div class="more">
                    <div class="music">
                        <img src="media/images/defaults/music.png" >
                        <span>${reels_data[i][4]}</span>
                    </div>
                    <div class="position">
                        <img src="media/images/defaults/map.png" >
...
<div class="likes">
    ...
    <div class="more">
        <img src="media/images/defaults/show_more.png" >
    </div>
    <div class="profile">
        <img src="${reels_data[i][1]}" >
    </div>
